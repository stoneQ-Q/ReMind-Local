...
export const REMIND_DATABASE_SCHEMA_VERSION = 20;
...
export const LAST_WECHAT_SYNC_AT_SETTING = 'diagnostics.wechat.last_sync_at';
export const LAST_WECHAT_SYNC_ERROR_SETTING = 'diagnostics.wechat.last_error';
